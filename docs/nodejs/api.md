...
-   `options` **[Object](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)?** Options for creating an OSRM object. (optional, default `{shared_memory:true}`)
